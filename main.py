...
# ✅ إعداد واجهة التطبيق
st.set_page_config(page_title="نظام الموجه التربوي الذكي", layout="wide")
...
if page == "🏠 الصفحة الرئيسية":
    st.title("📚 نظام الموجه التربوي الذكي")
    st.markdown("""
    مرحبًا بك في النظام الذكي لإدارة الغياب، الحالات الطارئة، الملاحظات، التوصيل المدرسي، والتحليل الارشادي التربوي.
